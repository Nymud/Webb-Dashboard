...
const dashboardSearch = document.querySelector('.search');
const magBG = document.querySelector('.mag-bg');
const userSearch = document.querySelector('.form-field');
const userMessage = document.querySelector('.form-area');
